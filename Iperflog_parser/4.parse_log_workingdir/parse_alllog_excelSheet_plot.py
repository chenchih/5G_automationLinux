...
# --- Plotting Function (Unchanged, as it relies on pandas reading the Excel file) ---
    ...
    try:
        ...
        for sheet_name, df in all_sheets_data.items():
            ...
            if 'Datetime' in df.columns and 'Tput' in df.columns:
                ...
                plt.close(fig)
                print(f"Plot for '{sheet_name}' saved as 'tput_adjusted_{sheet_name}.png'")
                plot_count += 1
            else:
...
if __name__ == "__main__":
    ...
    output_excel_file_path = f"all_logs_analysis_{timestamp}.xlsx"
