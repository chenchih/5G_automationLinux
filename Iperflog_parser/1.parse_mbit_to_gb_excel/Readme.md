...
- [V2.3: wrap up each feature into individual function](#v2.3)
	...
	- [[Improvement] Implement user to enter log filename](#v2.3_user_enter_logfile)
...
<a name="v3_fix003"></a>
#### [Fix Issue-004] Capture date with space for single date [🔺BACK](#v3)
...
match = re.match(r"(\w{3} \w{3}\s+\d{1,2} \d{2}:\d{2}:\d{2} \d{4}) \[SUM\].*?([\d\.]+) (bits|Mbits|Gbits)/sec",line)
	...
	.....
```
![v3_regularExpression](../img/parse_mbit_gbit/v3_reg.PNG)
...
#### [NEW] Set default output save file [🔺BACK](#v3) 
...
![v3.1_parse_mbit_gbit](../img/parse_mbit_gbit/v3_outputfile.PNG)
...
![v2_parse_mbit_gbit](../img/parse_mbit_gbit/v2.3.PNG)

<a name="v2.3_wrap_feature_function"></a>
#### [Improvement] wrap feature to function [🔺BACK](#v2.3) 
```
...
#### [Improvement] Implement user to enter log filename [🔺BACK](#v2.3)
```
...
#### [Fix Issue-001] parsing log file and cpature Mbit and Gbit [🔺BACK](#v2.2)
```
if "[SUM]" in line:
	#v2.2
...
![v2_parse_mbit_gbit](../img/parse_mbit_gbit/v2.3_reg.PNG)

<a name="v2.2_fixissue-003"></a>
#### [Fix Issue-003] convert tput value to gbit [🔺BACK](#v2.2)
...
#### [Improvement Target-003] Adust column width [🔺BACK](#v2.2)
...
#### [Improvement Target-004] adding progress bar [🔺BACK](#v2.2)
...
- [Known issue]
	...
	![v2.2_parse_mbit_gbit_resolve](../img/parse_mbit_gbit/v2.2_resolve.PNG)

- [Improvement]
	- Target-003: Excel timedate column width need to be adjust width
	- Target-004: Adding progress bar
	![v2.2_parse_mbit_gbit](../img/parse_mbit_gbit/v2.2_target.PNG)
...
![v2.1_parse_mbit_gbit](../img/parse_mbit_gbit/v2.1_output.PNG)


<a name="v2.1_writeExcel"></a>
#### [NEW]Write result into excel [🔺BACK](#v2.1)
...
#### ISSUE and Summary [🔺BACK](#v2.1)
- [Known issue]
	- [Resolve] ~~Issue-002~~: mbit log the unit show incorrrect
	![v2.1_resolve_parse_mbit_gbit](../img/parse_mbit_gbit/v2.1_resolve.PNG)
...
![v2_parse_mbit_gbit](../img/parse_mbit_gbit/v2_output.PNG)
...
![v2_parse_mbit_gbit](../img/parse_mbit_gbit/v2_regImprove.PNG)
...
#### [New] Write result into excel [🔺BACK](#v2)
```
import openpyxl
.....
if data:
...
- [issue]
	...
	```
	- Issue-004: The date contain one digit will not be able to capture, so you can see April 2, the 2 is not been capture	
	![v2_parse_mbit_gbit](../img/parse_mbit_gbit/v2_issue.PNG)
...
![v1_parse_mbit_gbit](../img/parse_mbit_gbit/v1_output.PNG)

<a name="v1_new_parse"></a>
####  [NEW] parsing log file and capture [🔺BACK](#v1)
```
try:
...
![v1_parse_mbit_gbit](../img/parse_mbit_gbit/v1_issue.PNG)
