...
import logchecking_rename_merge #renmae elog to static file name for pardsing
import parsefile_layer2_multiply_UE #filter the elog string like tput, bler, mfc and save to txt
import excel_layer2_multiply_UE #convert txt file to excel
import plot_graph_Excel_multiple #plot graph from excel data
...
excelfilename='data_result_multipleUE'
...
generated_result_filename = parsefile_layer2_multiply_UE.main(elogfileName)
print(generated_result_filename)

#generated_result_filename = 'result-2025-06-19-11-42-57.txt'
# Step3 convert txt file to excel 
print('\n######Step3: Convert txt result into Excel for plot graph #######')
listcurrentdir()
remove_excelfile()
#generated_result_filename='result-2025-06-18-17-50-16.txt'
excelfilename='data_result_multipleUE'
full_excel_path_for_plotting = excelfilename + ".xlsx"
excel_filecreate=excel_layer2_multiply_UE.main(generated_result_filename, full_excel_path_for_plotting)
if excel_filecreate:
    print(f'Log convert to excel file created')


full_excel_path_for_plotting = excelfilename + ".xlsx"
print(full_excel_path_for_plotting)

# Step4 plot graph
print('\n######Step4: Plot data and save to images #######')
plot_graph_Excel_multiple.main(full_excel_path_for_plotting)

# Step5 Wrapup result into folder
print('\n######Step5: Wrap up result into Folder#######\n')
datename = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
outfileName = f"{datename}_L2_MultipleUE_Result" # Using an f-string for clarity  
