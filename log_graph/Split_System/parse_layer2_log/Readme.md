...
- Step 3 convert the txt file result into excel file in step2.1 or step2.2


## 1. Single UE parsing log 

### Layer 2 Single UE get only Tput Value (ONLY DL)
...
### Layer 2 Single UE get related string
...
## 2. Multiple UE parsing log
**Description:** Layer 2 Multiply UE get related String
...
## 3. Merge Multiple Elog into one log file 
**Description:** If you have multiple elog especially running overnight or overweekend will contain multiple of elog file. In this sistuation you can instead merge multiple elog into one log file. 
...
- fix some issue read file in order: If your file is name XXX_8.txt,XXX_9.txt, XXX_10.txt, it will read like 10, 8, 9. in order to fixe this issue add `norsort`
```
...
## 4. Plot excel data into visualization:
**Description:** Draw line graph using `matplotlib.pyplot`(2022-06 update new feature)
